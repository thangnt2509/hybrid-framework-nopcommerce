...
public class User_01_Register_DRY_Level_0 {
	WebDriver driver;
	String emailAddress;
	...
	public void TC_02_Register_Invalid_Email() {
		...
		driver.findElement(By.cssSelector("input#Password")).sendKeys("123465");
		driver.findElement(By.cssSelector("input#ConfirmPassword")).sendKeys("123465");
